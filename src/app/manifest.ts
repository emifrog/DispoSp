...
export default function manifest(): MetadataRoute.Manifest {
  return {
    id: "/",
    name: "DispoSP — Disponibilités & planning",
    short_name: "DispoSP",
    ...
    icons: [
      ...
      // Android découpe l'icône à sa guise : la version « maskable » garde les
      // lettres dans le cercle de sécurité, quel que soit le masque du système.
