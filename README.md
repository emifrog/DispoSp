...
| `supabase/migrations/20260924090000_campagne_unique.sql`                          | Une campagne par mois et par équipe (index unique) ; refuse de s'appliquer, en le disant, si un doublon existe déjà                                                                                                 | **À appliquer avant de déployer le code**     |
| `supabase/migrations/20260925090000_participants_en_cours.sql`                    | Un membre qui devient actif dans une équipe — invitation, réactivation, changement d'équipe — est inscrit aux campagnes encore ouvertes de cette équipe, et prévenu ; rattrape ceux qui sont déjà arrivés trop tard | **À appliquer**, après `20260924090000`       |
