-- 0001 — Organizations, teams, profiles, rights, campaigns and availabilities.
-- Already applied to the dedicated development project on 18 September 2026.
-- Tested with PostgreSQL via PGlite (auth schema emulated in tests).
-- Not re-runnable: it creates objects. Apply it to a fresh database only.
begin;
